...
本门课至今已开设了三年，也很开心陪伴了我读研三年时光。至这门课开设以来，我们所有的资料都是开源的，**也非常鼓励大家参与开源建设**。

可以和大家分享的是，每一年优秀课设、高分同学一大半都参与过我们的开源项目。**有个别实验来源就是改编于往届同学的优秀课设**。
...
|  实验优化（文档）：对实验设计不足的地方进行优化，并撰写文档  |     +10~+20      | 如，ex2@[leexinhao](https://github.com/leexinhao)同学建议加入远程开发，助教采纳后并完善其初稿文档。本次ex2实验成绩给予满分。 |
| 新增实验（文档）：每一年都有优秀的同学根据自己的想法，完成非常优秀的课设，并提交文档（按照我们github实验文档格式） |   本门课程优秀   | 质量很重要，如果质量尚不足，只能给实验加分。不能算作总成绩优秀。 |
